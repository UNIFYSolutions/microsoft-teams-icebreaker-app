...
namespace Icebreaker
{
    ...
    {
        private readonly IcebreakerBotTableDataProvider dataProvider;
        ...
        public IcebreakerBot(IcebreakerBotTableDataProvider dataProvider, TelemetryClient telemetryClient)
        {
